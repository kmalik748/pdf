...
$pdf->setSignature($certificate, $certificate, 'testing@123', '', 2, $info);
...
$pdf->Image('http://localhost:8080/pdf/generated/Document_files/CerBg.png', 180, 60, 15, 15, 'PNG');
...
$path = "C:/xampp/htdocs/pdf/local.pdf";
$pdf->Output($path, 'F');
